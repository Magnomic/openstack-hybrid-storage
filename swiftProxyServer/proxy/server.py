...
class Application(object):
    ...
    def __init__(self, conf, memcache=None, logger=None, account_ring=None,
        ...
        self.account_ring = account_ring or Ring(swift_dir,
                                                 ring_name='account')
        self.partitionDictQueue = ''
        self.partitionSize = 0
        self.partitionFileNum = 0
        self.small_big_map = {}
        self.big_file_name = None
        self.data_source_queue = []
        self.offset_queue = ''
    ...
    def handle_request(self, req):
        ...
        try:
            ...
            #print (handler)#i changed here
            old_authorize = None
            #print (req.environ)#i changed here
            ...
            try:
                ...
                return handler(req) #here to handle the real function
            finally:
                if old_authorize:
