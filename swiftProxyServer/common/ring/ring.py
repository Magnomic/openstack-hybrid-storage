...
class Ring(object):
    ...
    def get_part(self, account, container=None, obj=None):
        ...
        :param source: from where the func is called
        :param req: request Item if from PUT Object
        ...
        # partStr = str(part)
        # print part
        # if source == 'PUT Object':
        #     try:
        #         buffer_dict = self.partFileDict[partStr]
        #         #buffer_size =
        #         print self.partFileBufferSize[partStr]
        #     except KeyError:
        #         self.partFileDict[partStr] = buffer_dict
        #         self.partFileBufferSize[partStr] = buffer_size
        #     finally:
        #         self.partFileDict[partStr] = buffer_dict + '|' + obj
        #         #self.partFileBufferSize[part] = buffer_size + req.content_length
        #         print 'for part : ' + partStr + ' adds files ' + self.partFileDict[partStr] \
        #               + " with size " #+ self.partFileBufferSize[partStr]
        return part
